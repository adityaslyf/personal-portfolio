  ...
  const experiences = [
    {
      ...
      description: "Worked on developing and maintaining the company's website and mobile application.",
      duration: "Jan 2020 - Present",
    },
    {
      title: "Intern at ABC",
      description: "Assisted in the development of a new feature for the company's main product.",
